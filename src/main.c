...
int test_array[] = {6, 4, 1, 326, 3, 236, 23, 3, 6, 3, 2, 667, 18, 6, 7, 8, 97, 567, 5, 10, 11};
const int test_array_lenght = 21;
...
int parallel_main()
{
    ...
    print_test_array();
    start = clock();
    double_sort(test_array, test_array_lenght);
    end = clock();
...
/*
    start = clock();
    bubbleSort(b_test_array, 18);
    end = clock();
    printf("BSORT took time: %f\n", ((double)(end - start)));
*/
